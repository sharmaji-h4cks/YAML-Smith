import {
  ...
  LanguageType,
} from '../schemas/dockerfileSchemas';
...
export class DockerfileGenerator {
  ...
  private generateRubyDockerfile(): string[] {
    const lines: string[] = [];
  ...
  // Helper methods
  private getBaseImageVariant(): string {
  ...
  private addNonRootUser(lines: string[]): void {
  ...
  private addEnvironmentVariables(lines: string[]): void {
  ...
  private addHealthCheck(lines: string[], defaultCommand?: string): void {
  ...
  private addLabels(lines: string[]): void {
    const allLabels = {
      'maintainer': 'YAML Smith',
      ...
      'org.opencontainers.image.vendor': 'YAML Smith',
      ...this.input.labels,
    };
  ...
  validate(): DockerfileValidation {
    const warnings: DockerfileValidation['warnings'] = [];
