...
import { DockerfileGenerator } from '../services/dockerfileGenerator';
import { DockerfileInput } from '../schemas/dockerfileSchemas';
...
export const generateDockerfile = async (
  ...
  try {
    const input: DockerfileInput = req.body;
    const generator = new DockerfileGenerator(input);
...
export const getDockerfileTemplates = async (
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> => {
